if ((obj_player1.state == 0 || obj_player1.state == 68 || obj_player1.state == 69 || obj_player1.state == 89 || obj_player1.state == 64) && sprite_index == spr_doorkey && obj_player1.key_up && global.key_inv && place_meeting(x, y, obj_player1))
{
